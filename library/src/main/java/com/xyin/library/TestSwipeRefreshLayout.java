...
/**
 * The RefreshLayout should be used whenever the user can refresh the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The RefreshLayout
 ...
 * width and the height supplied in this layout. The RefreshLayout does not
 * provide accessibility events; instead, a menu item must be provided to allow
 * refresh of the content wherever this gesture is used.
 * </p>
 */
public class TestSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = TestSwipeRefreshLayout.class.getSimpleName();
    ...
    public TestSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        Log.e(LOG_TAG, "TestSwipeRefreshLayout");
    }
    ...
    /**
     * Set a callback to override {@link TestSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (!isEnabled() || mReturningToStart || canChildScrollUp()
            ...
            Log.e(LOG_TAG, "onInterceptTouchEvent Fail fast if we're not in a state where a swipe is possible");
            return false;
        }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e(LOG_TAG, "onInterceptTouchEvent ACTION_MOVE");
                ...
                Log.e(LOG_TAG, "y = " + y + " ,overscrollTop = " + (y - mInitialMotionY) * DRAG_RATE);

                startDragging(y);
                break;

            case MotionEventCompat.ACTION_POINTER_UP:
                Log.e(LOG_TAG, "onInterceptTouchEvent ACTION_POINTER_UP");
                onSecondaryPointerUp(ev);
                break;

            case MotionEvent.ACTION_UP:
            case MotionEvent.ACTION_CANCEL:
                Log.e(LOG_TAG, "onInterceptTouchEvent ACTION_UP");
                mIsBeingDragged = false;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (!isEnabled() || mReturningToStart || canChildScrollUp()
                || mRefreshing || mNestedScrollInProgress) {
            // Fail fast if we're not in a state where a swipe is possible
            Log.e(LOG_TAG, "Fail fast if we're not in a state where a swipe is possible");
            return false;
        }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP: {
                Log.e(LOG_TAG, "onTouchEvent ACTION_UP");
                pointerIndex = ev.findPointerIndex(mActivePointerId);
                if (pointerIndex < 0) {
    ...
    /**
     * Classes that wish to override {@link TestSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link TestSwipeRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(TestSwipeRefreshLayout parent, @Nullable View child);
    }
}
